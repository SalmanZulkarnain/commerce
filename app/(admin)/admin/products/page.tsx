      ...
      <div className="max-w-6xl mx-auto space-y-5">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Manage stock, retail prices, and product details.</p>
          </div>
          ...
          <Table>
            <TableHeader className="bg-slate-50/50">
              <TableRow className="border-b border-slate-100">
                <TableHead className="font-semibold text-slate-500 text-xs tracking-wider pl-6 py-3.5">PRODUCT INFO</TableHead>
                <TableHead className="font-semibold text-slate-500 text-xs tracking-wider py-3.5">PRICE</TableHead>
                <TableHead className="font-semibold text-slate-500 text-xs tracking-wider py-3.5">STOCK</TableHead>
                <TableHead className="text-right font-semibold text-slate-500 text-xs tracking-wider pr-6 py-3.5">ACTION</TableHead>
              </TableRow>
            </TableHeader>
            ...
            <TableBody>
              {products.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={4} className="text-center py-12 text-sm text-slate-400 font-medium">
                ...
                products.map((prod) => (
                  ...
                  >
                    {/* Info Produk (Nama & Detail Singkat) */}
                    <TableCell className="py-4.5 pl-6">
                      <div className="flex items-center gap-3">
                        {/* Placeholder Kotak Gambar Produk */}
                        <div className="w-12 h-12 rounded-lg bg-slate-100 border border-slate-200/80 flex items-center justify-center text-[10px] font-bold text-slate-400 uppercase">
                          IMG
                        </div>
                        <div>
                          ...
                          <p className="text-[11px] text-slate-400 font-mono mt-0.5">ID: #{prod.id}</p>
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="py-4.5 text-sm font-medium">
                      {prod.stock <= 5 ? (
                        ...
                        <span className="text-slate-600 font-semibold">{prod.stock} pcs</span>
                      )}
                    </TableCell>
